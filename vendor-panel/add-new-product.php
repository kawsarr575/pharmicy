...
<?php 
    ...
    if(isset($_POST['add_product'])){
        ...
        if(empty($product_name)){
            ...
            $obj->product->create_product($product_name,$regular_price,$sale_price,$product_category,$product_des,$imageu,$product_restricted, $user_id);
                ...
                <div class="card-body">
                   ...
                   <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-check mb-4">
                            <input name="product_restricted" value="on" class="form-check-input" type="checkbox" id="autoSizingCheck">
                            <label class="form-check-label" for="autoSizingCheck">
                            Restricted Product ( If you would like to restrict this product then check )
                            </label>
                        </div>
