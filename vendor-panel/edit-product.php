...
<?php
    ...
    if(isset($_POST['update_product'])){
        ...
        $product_restricted  =   $_POST['product_restricted'];
        ...
        if(empty($product_name)){
            ...
            $obj->product->update_product($product_name,$regular_price,$sale_price,$product_category,$product_des, $product_restricted, $user_id,$product_id);
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-check mb-4">
                                <input name="product_restricted" <?php if($pro['product_restricted']){echo 'checked';} ?> class="form-check-input" type="checkbox" id="autoSizingCheck">
                                <label class="form-check-label" for="autoSizingCheck">
                                Restricted Product ( If you would like to restricted this product then checked )
                                </label>
                            </div>
